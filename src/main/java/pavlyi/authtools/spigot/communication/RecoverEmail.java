...
public class RecoverEmail {
    ...
    public String getSubject() {
        ...
        try {
            ...
            instance.log("&r  &cError: &fEmail for Recovery Code can't be found! Creating a new one...");
            exception.printStackTrace();
    ...
    public String getContent() {
        ...
        if (!getFile().exists()) {
            instance.log("&r  &cError: &fEmail for Recovery Code hasn't be found! Creating a new one...");
            instance.createEmailFile();
        }
    ...
    public File getFile() {
        return new File(instance.getDataFolder() + File.separator + "recovery_code_email.html");
    }
}
