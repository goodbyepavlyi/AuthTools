...
public class ConfigHandler {
	...
	public boolean SETTINGS_BUNGEECORD;
	...
	public void createConfig(boolean silently) {
	...
	public void loadConfig(boolean silently) {
		try {
			getConfig().load(f);
		...
		SETTINGS_BUNGEECORD = getConfig().getBoolean("settings.bungeeCord");
